                        ...
                        {loading ? (
                            ...
                            <form className="d-flex flex-wrap justify-content-between" id="personalInfo" onSubmit={handleSave}>
                                ...
                                <div className="input-container col-12 col-md-5 col-xxl-4 p-2">
                                    ...
                                    <input name="telephone" className="form-control col-12" type="tel" pattern="[3][7][5]-[0-9]{2}-[0-9]{3}-[0-9]{2}-[0-9]{2}" value={user.tel} onChange={handleChange} required />
                                </div>
                                <div className="input-container col-12 col-md-5 col-xxl-4 p-2">
                                    <label htmlFor="age">Возраст <span className="text-danger">*</span></label>
                                    <input name="age" className="form-control col-12" type="number" value={user.age} onChange={handleChange} min={1} max={120} required />
                                </div>
                                <div className="input-container col-12 col-md-5 col-xxl-4 p-2">
                                ...
                                <div className="input-container col-12 col-md-5 col-xxl-4 p-2">
                                    ...
                                    <input name="password" className="form-control col-12" type="password" value={user.password} onChange={handleChange} minLength={8} maxLength={16} required />
                                </div>
