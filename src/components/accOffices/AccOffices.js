...
const AccOffices = (props) => {
    ...
    return (
        <div className="offices-wrapper wrapper col-12 col-md-7 col-xxl-8 my-4 my-sm-1 my-lg-3 my-xl-4">
            <div className="wrapper-office col-12 d-flex flex-wrap">
                ...
                <div className="office-price col-12 col-xxl-2 py-2 px-xxl-2 py-xxl-0">
                    <h6>Цена за м²:</h6>
