...
const AccOffices = (props) => {
    ...
    return (
        <div className="office col-12 col-md-7 col-xxl-8 my-4 my-sm-1 my-lg-3 my-xl-4">
            { props.userRole === "User" ? null : <div className="btn btn-outline-dark office-add col-12 py-1 rounded-0" data-bs-toggle="modal" data-bs-target="#modalAdd"><i class="bi bi-plus-lg"></i></div>}
